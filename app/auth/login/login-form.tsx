...
function LoginForm() {
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-8">
        <h1 className="font-sans text-2xl font-semibold text-foreground tracking-tight mb-1.5">
          Welcome back
        </h1>
        <p className="text-sm text-muted-foreground">
          Sign in to continue to AethLife
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <Link href="/auth/forgot-password" className="text-xs text-teal-500 hover:text-teal-600 transition-colors">
              Forgot password?
            </Link>
          </div>
